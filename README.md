...
- **Agent-agnostic** - choose a [supported native or ACP agent](https://kunchenguid.github.io/no-mistakes/reference/global-config/#agent), with ordered fallbacks; every gate requires a runnable configured pipeline agent.
